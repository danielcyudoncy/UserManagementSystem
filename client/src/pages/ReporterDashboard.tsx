          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              <div className="w-8 h-8 bg-primary rounded-lg flex items-center justify-center">
                <CheckSquare className="text-primary-foreground text-sm" />
              </div>
              <div>
                <h1 className="text-xl font-bold text-gray-900 dark:text-white">TaskManager</h1>
                <p className="text-sm text-gray-500 dark:text-gray-400">Reporter Dashboard</p>
              </div>
            </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                ...
                <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900/20 rounded-lg flex items-center justify-center">
                  <CheckSquare className="text-blue-600 dark:text-blue-400 text-xl" />
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="mb-6">
          <div className="border-b border-gray-200 dark:border-gray-700">
            <nav className="-mb-px flex space-x-8">
              {[
                { id: "assigned", label: "Assigned to Me", count: myTasks?.length || 0 },
                { id: "created", label: "Created by Me", count: (allTasks || []).filter(task => task.createdBy === appUser?.uid).length },
            ...
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  {activeTab === "assigned" ? "You don't have any assigned tasks yet." :
